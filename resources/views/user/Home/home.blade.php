                                        ...
                                        <div class="col-lg-5 col-md-8">
                                            <div class="banner_text">
                                                <div class="banner_text_iner">
                                                    ...
                                                    @if (Session::has('banner_link'))
                                                        <a href="{{ $banner->banner_link }}" class="btn_2">{{ $banner->button_text }}</a>
                                                    @else
                                                        <a href="{{ route('shop') }}" class="btn_2">{{ $banner->button_text }}</a>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                        <div class="banner_img d-none d-lg-block">
                                            <img src="/storage/banner/{{ $banner->image }}" alt="">
                                        </div>
                                    </div>
                                </div>
                            @endif
        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-6 col-md-6">
                    <div class="offer_img">
                        <img src="{{ asset('assets/img/offer_img.png') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="single_client_logo">
                        <img src="{{ asset('assets/img/client_logo/client_logo_1.png') }}" alt="">
                    </div>
                    <div class="single_client_logo">
                        <img src="{{ asset('assets/img/client_logo/client_logo_2.png') }}" alt="">
                    </div>
                    <div class="single_client_logo">
                        <img src="{{ asset('assets/img/client_logo/client_logo_3.png') }}" alt="">
                    </div>
                    <div class="single_client_logo">
                        <img src="{{ asset('assets/img/client_logo/client_logo_4.png') }}" alt="">
                    </div>
                    <div class="single_client_logo">
                        <img src="{{ asset('assets/img/client_logo/client_logo_5.png') }}" alt="">
                    </div>
                    <div class="single_client_logo">
                        <img src="{{ asset('assets/img/client_logo/client_logo_3.png') }}" alt="">
                    </div>
