...
<body>
    ...
    <header class="main_menu home_menu">
        <div class="container-full">
            <div class="col-lg-12" style="height: 40px;padding-top:5px; text-align:center;background-color:#ff3368">
                <p class="text-white">Your order will be delivered in 4 business days</p>
            </div>
        </div>
        <div class="container">
                        ...
                        <div class="hearer_icon d-flex">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="javascript:void(0)">Wishlist</a>
                                    <a class="dropdown-item" href="javascript:void(0)">Gift Cards</a>
    ...
    <!--footer_part start-->
    <footer class="footer_part" style="background: #ecfdff">
        <div class="container">
