    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <a class="btn btn-primary text-white" href="{{ route('admin.sub_categories.create') }}">
                        ...
                        <tbody>
                            @foreach ($sub_categories as $i => $sub_category)
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" data-id="{{ $sub_category->id }}" name="status" class="switch-btn" data-size="small" data-color="#0099ff" {{ $sub_category->status == '1' ? 'checked' : '0' }}>
                                    </td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                ...
                                                <a class="dropdown-item" href="{{ route('admin.sub_categories.edit',$sub_category->id) }}"><i class="dw dw-edit2"></i> Edit</a>
